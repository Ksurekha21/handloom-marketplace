        ...
        {filteredItems.map((i) => (
          <div key={i.id} className="resource-card">
            <div style={{position: 'relative'}}>
              {i.image_url ? <img src={i.image_url} alt="" className="resource-image" /> : <div className="resource-image" style={{background: '#eee', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '40px'}}>🧶</div>}
